...
public abstract class SLMulNode extends SLBinaryNode {
    ...
    protected ValkyrieInteger doSLBigInteger(ValkyrieInteger left, ValkyrieInteger right) {
        return new ValkyrieInteger(left.value.multiply(right.value));
    }
    ...
    protected ValkyrieInteger doInteropBigInteger(Object left, Object right,
        ...
        try {
            return new ValkyrieInteger(leftLibrary.asBigInteger(left).multiply(rightLibrary.asBigInteger(right)));
